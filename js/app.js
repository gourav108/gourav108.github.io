...
var storeApp = angular.module('store', ['ngRoute', 'ngAnimate', 'initialValue']).
  config(['$routeProvider', function($routeProvider) {
  $routeProvider.
    when('/bar', {
    templateUrl: 'partials/barcode.htm',
...
/*  will use if we wanted to send email  */
storeApp.controller('postController', function ($scope, $http) {
    ...
    $scope.submitForm = function (contactform) {
        ...
        var myCart = new shoppingCart("selfcheckout");
        ...
        if(myCart.items.length != 0){
            ...
            if (contactform.$valid) {
                ...
                $http.post('', JSON.stringify(totalData)).success(function () {
